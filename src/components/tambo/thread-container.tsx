  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Only apply full screen height and positioning when not in a constrained container
        className?.includes('h-full') ? '' : 'h-screen',

        // Add smooth transitions for layout changes
        'transition-all duration-200 ease-in-out',

        // Only apply sidebar spacing and width constraints if not overridden by custom classes
        ...
        // Custom classes passed via props (these will override defaults)
        className,
      )}
      {...props}
    >
